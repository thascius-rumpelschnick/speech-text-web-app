 ...
 */
const CloudArrowUp = ({ color, dimension }: Props) => {
    return (
        <svg
 ...
 */
const ExclamationCircle = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const FileTypePDF = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const Floppy = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const Microphone = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const Pencil = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const Trash = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
 ...
 */
const XCircle = ({ color, dimension }: Props) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={dimension ?? "16"}
...
export { CloudArrowUp, ExclamationCircle, FileTypePDF, Floppy, Microphone, Pencil, Trash, XCircle };
